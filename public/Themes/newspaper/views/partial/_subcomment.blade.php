                                            ...
                                            <div class="comment-content d-flex">
                                                ...
                                                <div class="comment-meta">
                                                    <a href="{{'http://'.$subcomments['website']}}" class="post-author">{{$subcomments['nama']}}</a>
                                                    <a href="#" class="post-date">{{ date('F d, Y' , strtotime($subcomments['created_at'])) }}</a>
                                                    <p>{{$subcomments['content']}}</p>
                                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#balasKomentar-{{$subcomments['id']}}">Balas</button>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="balasKomentar-{{$subcomments['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <div class="contact-form-area">
                                                        <input type="hidden" name="parent" value="{{$subcomments['id']}}">
