...
@section('breadcrumb_tittle', __('Category : ').$category->nama)
@section('breadcrumb_map', $category->nama)
@section('content')

          <div class="row">
          @foreach($categoryPost as $artikel)
          <div class="col-lg-4  col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up">
            <article class="entry">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-tag"></i> <a href="{{route('frontend.category.post', $category->slug)}}">{{$category->nama}}</a></li>
