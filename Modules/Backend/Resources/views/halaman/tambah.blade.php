...
@section('tittle', __('Tambah Halaman - KeetaCMS Admin'))
@section('konten')
  ...
  <section class="content">
    <div class="row">
      ...
      <form method="POST" action="{{route('halaman.store')}}">
        @csrf
      <div class="col-md-9">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">{{ __('Buat Halaman')}}</h3>
            </div>
            <div class="box-body">
              <input type="text" name="judul" class="form-control input-lg" placeholder="Judul Halaman">
              <br>
