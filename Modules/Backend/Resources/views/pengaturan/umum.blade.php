...
@section('tittle', __('Pengaturan Umum - KeetaCMS Admin'))
@section('konten')
  ...
  <section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">{{ __('Pengaturan Umum')}}</h3>
          			...
          			<div class="modal fade" id="modal-{{$setting->id}}">
	                    <div class="modal-dialog">
	                      <div class="modal-content">
	                        ...
	                        <form method="POST" action="{{route('umum.update', $setting->id)}}">
	                            @csrf
	                            @method('PUT')
	                        <div class="modal-body">
	                        	...
	                        	<div class="form-group">
		                          ...
		                          @if($setting->key == 'web_description' || $setting->key == 'web_keyword' || $setting->key == 'address')
		                          	<textarea class="form-control" name="value" id="value">{{$setting->value}}</textarea>
		                          @else
