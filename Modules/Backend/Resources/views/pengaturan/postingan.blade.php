...
@section('tittle', __('Pengaturan Postingan - KeetaCMS Admin'))
@section('konten')
  ...
  <section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">{{ __('Pengaturan Postingan')}}</h3>
          			...
          			<div class="modal fade" id="modal-{{$setting->id}}">
	                    <div class="modal-dialog">
	                      <div class="modal-content">
	                        ...
	                        <form method="POST" action="{{route('postingan.update', $setting->id)}}">
	                            @csrf
	                            @method('PUT')
